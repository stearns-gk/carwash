...
function registerCarwashItem(oData) {

    var actualUnitPrice = "4.99";
    var receiptCode = "Carwash Code #" + Math.floor(100000 + Math.random() * 900000)
    var taxGroup = "A1"

     // Modify these hard-coded item params to suit your needs
     var oRequest = {
        "posItemID": "6665556665552",
        "itemID": "66601560157",
        "unitOfMeasureCode": "PCE",
        "itemType": "CO",
        "actualUnitPrice": actualUnitPrice,
        "quantity": "1",
        "receiptText": receiptCode,
        "registrationNumber": "66601560157",
        "mainPOSItemID": "6665556665552",
        "taxGroupID": taxGroup,
    };
